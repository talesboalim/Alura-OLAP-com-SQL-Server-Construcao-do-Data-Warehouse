...
GO
PRINT N'Rename refactoring operation with key 989cabf3-95c2-490e-a929-03e3cde80248 is skipped, element [dbo].[Fato_001].[Id] (SqlSimpleColumn) will not be renamed to Cod_Cliente';


GO
PRINT N'Rename refactoring operation with key 6cad97b7-032d-4d8e-9586-a92a417fdbce is skipped, element [dbo].[Fato_001].[Unidades_Vendida] (SqlSimpleColumn) will not be renamed to Unidade_Vendida';
...
GO
ALTER TABLE [dbo].[Fato_001] WITH CHECK CHECK CONSTRAINT [FK_Fato_001_DimCliente];
...
ALTER TABLE [dbo].[Fato_002] WITH CHECK CHECK CONSTRAINT [FK_Fato_002_DimCliente];
...
ALTER TABLE [dbo].[Fato_004] WITH CHECK CHECK CONSTRAINT [FK_Fato_004_DimCliente];
